    ...
    ($.fn.fileuploader = function (q) {
                ...
                f = {
                        ...
                        return (
                            ...
                            f.isSupported()
                                ? (!n.beforeRender || !$.isFunction(n.beforeRender) || !1 !== n.beforeRender(p, s)) &&
                                  (f.redesign(), n.files && f.files.append(n.files), (f.rendered = !0), n.afterRender && $.isFunction(n.afterRender) && n.afterRender(l, p, o, s), void (f.disabled || f.bindUnbindEvents(!0)))
                            ...
                            var i = e.html.find(".fileuploader-item-image"),
                                ...
                                d = function (t) {
                                    ...
                                    i.removeClass("fileuploader-no-thumbnail fileuploader-loading").html(r),
                                        r.is("img") &&
                                            r.attr("draggable", "false").on("load error", function (t) {
                            ...
                            if (n.thumbnails.popup && n.thumbnails._selectors.popup) {
                                ...
                                var t = e.popup.html || $(f._assets.textParse(n.thumbnails.popup.template, e)),
                                    ...
                                    i = function () {
                                        ...
                                        o.css({ height: "100%" }), r && i > r.outerHeight() && (i = r.outerHeight()), o.css({ height: i });
                                    },
                                    a = function (t) {
                                ...
                                t.show().appendTo(p),
                                    ...
                                    e.reader.node && (r && t.find(".fileuploader-popup-preview .node").html(e.reader.node), (e.reader.node.controls = !0), (e.reader.node.currentTime = 0), e.reader.node.play && e.reader.node.play()),
                                    $(window).on("keyup", a),
                                    $(window).on("resize", i),
                                    i.call(),
                                    setTimeout(function () {
                                    ...
                                    e.editor && e.popup.editor && e.popup.editor.hasChanges
                                        ? (e.popup.editor && e.popup.editor.rotation && f.editor.rotate(e, e.editor.rotation || 0, !0),
                                          e.popup.editor &&
                        ...
                        rotate: function (e, t, o) {
                            ...
                            if (!e.popup.editor.isAnimating) {
                                ...
                                var r = e.popup.html.find(".node"),
                                    i = r.find("> img"),
                                    a = { rotation: (n = e.popup.editor.rotation || 0), scale: e.popup.editor.scale || 1 };
                                    ...
                                    $(a).animate(
                                        { rotation: e.popup.editor.rotation, scale: e.popup.editor.scale },
                                        {
                                            ...
                                            step: function (e, t) {
                                                ...
                                                i.css({ "-webkit-transform": "rotate(" + n + "deg) scale(" + r + ")", "-moz-transform": "rotate(" + n + "deg) scale(" + r + ")", transform: "rotate(" + n + "deg) scale(" + r + ")" });
                                            },
                                            always: function () {
                                ...
                                (e.popup.editor.cropper = {
                                    ...
                                    init: function (t) {
                                        ...
                                        o.isCropping || (o.$imageEl.clone().appendTo(o.$template.find(".area-image")), o.$imageEl.parent().append(r)),
                                            o.$template.hide().css({ left: i.left, top: i.top, width: a, height: l }).fadeIn(150),
                                            o.$editor.hide(),
                                            ...
                                            o.isCropping ||
                                                o.$template.on("drop dragend dragleave dragover dragenter dragstart touchstart touchmove touchend touchcancel", function (e) {
                                                    e.preventDefault();
                                                }),
                                    ...
                                    setDefaultData: function () {
                                        ...
                                        return (t.crop = { left: 0, top: 0, width: i ? r * a : n, height: i ? n * a : r, cfWidth: n / t.$imageEl.prop("naturalWidth"), cfHeight: r / t.$imageEl.prop("naturalHeight") }), null;
                                    },
                                    hide: function (t) {
                                        var o = e.popup.editor.cropper;
                                    ...
                                    resize: function (t) {
                                        ...
                                        n.width() > 0 &&
                                            (t
                                                ...
                                                : ((o.crop.cfWidth = n.width() / n.prop("naturalWidth")), (o.crop.cfHeight = n.height() / n.prop("naturalHeight"))));
                                    },
                                    ...
                                    mousedown: function (t) {
                                        var o = t.originalEvent.touches && t.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                            ...
                                            a = function () {
                                                (r.pointData = { el: n, x: i.x, y: i.y, xEditor: i.x - r.crop.left, yEditor: i.y - r.crop.top, left: r.crop.left, top: r.crop.top, width: r.crop.width, height: r.crop.height }),
                                    ...
                                    mousemove: function (t) {
                                        ...
                                        if (r.isResizing) {
                                            var s,
                                                p = r.pointData.el.attr("class").substr("point point-".length),
                                            ...
                                            if (
                                                ...
                                                ("a" == p || "b" == p || "c" == p) &&
                                                    ...
                                                    r.crop.top > r.crop.top + r.crop.height && ((r.crop.top = u), (r.crop.height = 0)),
                                                    r.crop.height < h && ((r.crop.top = u - h), (r.crop.height = h)),
                                                    (s = m ? f._assets.ratioToPx(r.crop.width, r.crop.height, m) : null) &&
                                                        ((r.crop.width = s[0]),
                                            ...
                                            if (
                                                ...
                                                r.crop.left > r.crop.left + r.crop.width && ((r.crop.left = d), (r.crop.width = 0)),
                                                r.crop.width < c && ((r.crop.left = d - c), (r.crop.width = c)),
                                                (s = m ? f._assets.ratioToPx(r.crop.width, r.crop.height, m) : null) &&
                                                    ((r.crop.height = s[1]),
                        ...
                        save: function (e, t, r, i, a) {
                            ...
                            if (((c.width = m.naturalWidth), (c.height = m.naturalHeight), h.drawImage(m, 0, 0), void 0 !== e.editor.rotation)) {
                                ...
                                var v = (e.editor.rotation * Math.PI) / 180,
                                    b = 0.5 * c.width,
                                    w = 0.5 * c.height;
                                h.clearRect(0, 0, c.width, c.height), h.translate(b, w), h.rotate(v), h.translate(0.5 * -m.naturalWidth, 0.5 * -m.naturalHeight), h.drawImage(m, 0, 0), h.setTransform(1, 0, 0, 1, 0, 0);
                            }
                            if (e.editor.crop) {
                    ...
                    sorter: {
                        ...
                        mousedown: function (e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                ...
                                i = f.files.find(r),
                                a = { x: "mousedown" != t && r.length ? e.originalEvent.touches[0].pageX : e.pageX, y: "mousedown" != t && r.length ? e.originalEvent.touches[0].pageY : e.pageY },
                                s = function () {
                                    (f.sorter.sort = {
                                        el: o,
                                        item: i,
                            ...
                            f.sorter.sort && f.sorter.mouseup(),
                                i &&
                                    ((n.sorter.selectorExclude && (o.is(n.sorter.selectorExclude) || o.closest(n.sorter.selectorExclude).length)) ||
                                        (p.on(f.sorter.prevent(!0), n.thumbnails._selectors.sorter, f.sorter.prevent),
                                        "mousedown" == t && s(),
                                        "touchstart" == t &&
                        ...
                        mousemove: function (e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                ...
                                p = { x: "mousedown" == t ? e.pageX : e.originalEvent.touches[0].pageX, y: "mousedown" == t ? e.pageY : e.originalEvent.touches[0].pageY },
                            ...
                            d + o.xItem > a.width() && (d = a.width() - o.xItem),
                                ...
                                r.html.addClass("sorting").css({ position: "fixed", left: d, top: u, width: f.sorter.sort.width, height: f.sorter.sort.height }),
                            ...
                            if (c) {
                                ...
                                c[g](o.placeholder), c[g](r.html), (f.sorter.sort.lastHover = { el: c[0], x: p.x, y: p.y, direction: g }), a.scrollLeft(s.left), a.scrollTop(s.top);
                            }
                        },
                        mouseup: function () {
                            var e = f.sorter.sort,
                    ...
                    upload: {
                        ...
                        send: function (e, t) {
                            if (e.upload) {
                                ...
                                if (n.upload.chunk && e.file.slice) {
                                    ...
                                    if ((d > 1 && !e.upload.chunk && (e.upload.chunk = { name: e.name, size: e.file.size, type: e.file.type, chunkSize: a, temp_name: e.name, loaded: 0, total: d, i: -1 }), e.upload.chunk))
                                        if (
                                            (e.upload.chunk.i++,
                                ...
                                if (
                                    ...
                                    e.html && (n.thumbnails._selectors.start && e.html.find(n.thumbnails._selectors.start).remove(), r()),
                                    e.upload.data)
                                )
                        ...
                        progressHandling: function (e, t, r, i) {
                            if ((!e && i && t.upload.$ajax && (e = { total: t.upload.$ajax.total, loaded: t.upload.$ajax.total, lengthComputable: !0 }), e.lengthComputable)) {
                        ...
                        onDrop: function (e) {
                            clearTimeout(f.dragDrop._timer),
                                ...
                                e &&
                                    ...
                                    (f.isUploadMode() ? f.onChange(e, e.originalEvent.dataTransfer.files) : s.prop("files", e.originalEvent.dataTransfer.files)),
                    ...
                    files: {
                        ...
                        read: function (e, t, r, i) {
                            if (f.isFileReaderSupported()) {
                                ...
                                if ((((!e.reader.src && !e.reader._FileReader) || i) && (e.reader = { _FileReader: a, _callbacks: [], read: e.reader.read }), e.reader.src && !i)) return t && $.isFunction(t) ? t(e, l, p, o, s) : null;
                                ...
                                if ("astext" == e.format)
                                    ...
                                    (a.onload = function (t) {
                                        ...
                                        d ? a.readAsDataURL(e.file) : a.onload({ target: { result: e.file } });
                                        ...
                                        ? ((c = d ? URL.createObjectURL(e.file) : e.file),
                                          (h.onloadedmetadata = function () {
                                              (e.reader.node = h),
                                                  ...
                                                  "video" == e.format && ((e.reader.width = h.videoWidth), (e.reader.height = h.videoHeight), (e.reader.ratio = f._assets.pxToRatio(e.reader.width, e.reader.height)));
                                          }),
                                          (h.onerror = function () {
                                              u(), (e.reader = { read: e.reader.read });
                                          }),
                        ...
                        list: function (e, t, r, i) {
                            var a = [];
                            return (
                                !n.sorter || r || (i && "ignoreSorter" == i) || f.sorter.save(!0),
                                $.each(f._itFl, function (o, n) {
                                    if (n.upload && !n.uploaded) return !0;
                                    var r = n;
                                    if (
                                        ((t || e) && (r = (r.choosed ? "0:/" : "") + (t && null !== f.files.getItemAttr(n, t) ? f.files.getItemAttr(n, t) : n["string" == typeof n.file ? "file" : "name"])),
                                        e &&
                                            ((r = { file: r }),
                                            n.editor && (n.editor.crop || n.editor.rotation) && ((r.editor = {}), n.editor.rotation && (r.editor.rotation = n.editor.rotation), n.editor.crop && (r.editor.crop = n.editor.crop)),
                        ...
                        check: function (e, t, r) {
                            ...
                            if (null != n.maxSize && r) {
                                ...
                                if (
                                    ...
                                    return (i[1] = f._assets.textParse(n.captions.errors.filesSizeAll)), (i[3] = !0), i;
                            }
                                ...
                                if (
                                    ($.each(f._itFl, function (o, r) {
                                        if (r != e && 1 == r.choosed && r.file && r.name == e.name)
                                            return (
                                                (a = !0),
                                                r.file.size != e.size || r.file.type != e.type || (e.file.lastModified && r.file.lastModified && r.file.lastModified != e.file.lastModified) || !(t.length > 1)
                                                    ? ((i[1] = f._assets.textParse(n.captions.errors.fileName, e)), (i[2] = !1))
                                                    : (i[2] = !0),
                                                !1
                                            );
                                    }),
                        ...
                        remove: function (e, t) {
                            if (t || !n.onRemove || !$.isFunction(n.onRemove) || !1 !== n.onRemove(e, l, p, o, s)) {
                                if (
                                    (e.html && (n.thumbnails.onItemRemove && $.isFunction(n.thumbnails.onItemRemove) && !t ? n.thumbnails.onItemRemove(e.html, l, p, o, s) : e.html.remove()),
                                    e.upload && e.upload.$ajax && e.upload.cancel && e.upload.cancel(!0),
                                    e.popup && e.popup.html && e.popup.html.remove(),
                                    e.reader.src && ((e.reader.node = null), URL.revokeObjectURL(e.reader.src)),
                                    e.input)
                                ) {
                                    var r = !0;
                                    $.each(f._itFl, function (o, n) {
                        ...
                        isBrightColor: function (e) {
                            var t = function (e) {
                                ...
                                return e && e.constructor == Array && 3 == e.length
                                    ...
                                    : (t = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(e))
                            ...
                            return (
                                (function (e) {
                                    var o = t(e);
                                    return o ? 0.2126 * o[0] + 0.7152 * o[1] + 0.0722 * o[2] : null;
                                })(e) > 194
                            );
                        },
                    },
        ...
        ($.fn.fileuploader.defaults = {
            ...
            thumbnails: {
                ...
                boxAppendTo: null,
                item:
                    '<li class="fileuploader-item"><div class="columns"><div class="column-thumbnail">${image}<span class="fileuploader-action-popup"></span></div><div class="column-title"><div title="${name}">${name}</div><span>${size2}</span></div><div class="column-actions"><a class="fileuploader-action fileuploader-action-remove" title="${captions.remove}" style="color:red;">x</a></div></div><div class="progress-bar2">${progressBar}<span></span></div></li>',
                item2:
                ...
                popup: {
                    template: function (e) {
                        return (
                            ...
                            ("image" == e.format && e.reader.src && e.editor ? '<li><a data-action="crop"><i></i><span>${captions.crop}</span></a></li><li><a data-action="rotate-cw"><i></i><span>${captions.rotate}</span></a></li>' : "") +
