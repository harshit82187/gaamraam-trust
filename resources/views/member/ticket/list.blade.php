            ...
            <div class="card-header" style="display: flex;justify-content: space-between;align-items: center;">
                ...
                <div style="display: flex; gap: 10px; align-items: center;justify-content: space-between;">
                    <form action="{{ url()->current() }}" method="get" style="display: flex;gap:15px;">
                        ...
                        <a href="{{ route('member.tickets.add') }}" class="btn btn-dark" style="width:58%;">Add Ticket</a>
                    ...
                    <table class="table align-middle table-nowrap ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                 <a href="{{ route('member.tickets.info',encrypt($ticket->id)) }}" class="btn btn-sm btn-primary">View</a>
                                </td>
                            </tr>
                            @endforeach        
                            @else 
