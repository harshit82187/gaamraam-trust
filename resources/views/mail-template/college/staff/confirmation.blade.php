...
<html>
	<head>
		...
		<title>Colege Member Confirmation</title>
	...
	<body>
		<div class="email-container">
            <div class="email-header" style="margin-bottom: 20px;">
                ...
                <h2>College Staff Member Confirmation</h2>
            </div>
			<div class="email-body">
				<p>Hello <strong>{{ $data['name'] ?? '' }}</strong>,</p>
                <p>Your account has been successfully registered.</p>
                <p>👤 <strong>Login Username:</strong> {{ $data['email'] }}</p>
				<p>🔐 <strong>Login Password:</strong> {{ $data['password'] }}</p>
				<div>
					<p>Click the link below to log in to your dashboard:  <br>
						<a href="{{ url('our-institutions') }}" style="display: inline-block; background-color: #ff7029; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">	Login Here</a>	
					</p>
				</div>
