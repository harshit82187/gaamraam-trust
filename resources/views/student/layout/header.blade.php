	...
	<div class="layout-width">
		<div class="navbar-header">
            ...
            @php
			  ...
			  $notifications = \App\Models\Notification::whereJsonContains('user_id', (string) $student->id)->orWhereJsonContains('user_id', "0")->count();
			 @endphp
			<div class="d-flex align-items-center gap-3">
				...
				<div class="dropdown header-item topbar-user" style="background-color:#d85f3b">
					<button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<span class="d-flex align-items-center">
							@if(auth()->guard('student')->user()->image == null)
							<img class="rounded-circle header-profile-user" src="{{ asset('student/backend/male.jpeg') }}" alt="Header Avatar">
							@else
					...
					<div class="dropdown-menu dropdown-menu-end">
						<!-- item-->
						<h6 class="dropdown-header">Welcome {{ auth()->guard('student')->user()->name ?? 'N/A' }}!</h6>
