...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
	<head>
		<meta charset="utf-8" />
		<title>Employee Password Update - Gaam Raam Trust</title>
							...
							<div class="card mt-4">								
								<div class="card-body p-4">
									<div class="text-center mt-2">
										<h5 class="text-primary" style="color:#ff7029 !important">Employee Update  Password</h5>
									</div>
									<div class="p-2 mt-4">
										<form id="forgot-passward-form" action="{{ route('admin.postresetPassword') }}" method="POST" >
											@csrf
