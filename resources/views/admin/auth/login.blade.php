...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
	<head>
		<meta charset="utf-8" />
		<title>Admin Login - Gaam Raam Trust</title>
						...
						<div class="col-md-8 col-lg-6 col-xl-5">
							<div class="card mt-4">
								<div class="card-body p-4">
									...
									<div class="p-2 mt-4">
										<form id="admin-login" class="needs-validation" novalidate action="{{ route('admin.login') }}" method="POST" >
											@csrf
											<div class="mb-3">
											...
											<div class="mt-4 text-center">
												<div class="signin-other-title">
													<a href="{{ route('admin.forget-passwords') }}" class="fs-13 mb-4 title">Forget password</h5></a>
												</div>
											</div>
										</form>
